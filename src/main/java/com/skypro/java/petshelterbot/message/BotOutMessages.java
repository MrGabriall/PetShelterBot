...
public class BotOutMessages {
    ...
    public static final String PET_MANAGEMENT_ONLY_PHOTO = "Вы прислали  только фото, нужно прислать ещё письменный отчёт.  ";
    public static final String PET_MANAGEMENT_ONLY_REPORT = "Вы прислали только отчёт,нужно добавить ещё и фото.  ";
    public static final String PET_MANAGEMENT_CAUTION_ON_REPORT = "!!!!!!!Предупреждаем Вас о том ,что  вы плохо  заполняете отчёт  (делает волонтер):!!!!!!!\n" + "  "
