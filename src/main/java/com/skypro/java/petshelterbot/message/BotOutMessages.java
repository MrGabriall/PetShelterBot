...
public class BotOutMessages {
    ...
    public static final String NEW_USER_HELLO = "Здравствуй дорой друг." + "Ты попал в самый уникальный приют в мире," + "у тебя есть уникальная возможность совершить добрый поступок," + " и стать обладателем домашнего питомца. ";
    public static final String NEW_USER_INFO_START = "Наш приют содержит более 1000 питомцев," + "которые каждый день получают самую лушую заботу в мире," + "ещё наш приют обладает сервисом  помощи нашим подопечным," + "прислать Вашу помощь  можно на номер 8 (54545)-5858-67858.";
    ...
    public static final String POTENTIAL_ANIMAL_OWNER_REGULATIONS_ANIMAL = " Правила знакомства с собакой,прежде чем взять питомца из приюта.\n" + "Вам нужно познакомиться с питомцем и привыкнуть друг к другу " + "для этого необходимо, каждый день посещять приют." + " и кормить питомца всякими вкусняшками.";
    ...
    public static final String POTENTIAL_ANIMAL_OWNER_ADVICE_COMMUNICATION_ANIMAL = " Советы кинолога по первичному общению с собакой.\n" + "1 Не смотри собаке в глаза.\n" + "2 Подкорми собаку сладким.\n" + "3 Погладь собаку.\n" + "4 Поиграй с собакой.";
    public static final String POTENTIAL_ANIMAL_OWNER_RECOMMENDATIONS_ON_CANINELOGIST = "!!!!!!Список профессиональных кинологов!!!!!!\n" + "1 Стрежонов Игорь  стаж  5 лет телефон 7 (98980)-6789-6566\n" + "2 Волков Александр стаж  7 лет телефон 8 (543453)-9898-988\n" + "3 Вортников Павел стаж  10 лет телефон 8 (785869)-989-989";
